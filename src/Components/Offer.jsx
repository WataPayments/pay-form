    ...
    >
      <div className="offer-content">
        ...
        <div className="offer-blocks">
          ...
          <div className="block">
            <p className="p2">
              1. Предмет оферты Поставщик предоставляет услуги по приёму
              платежей от клиентов, включая, но не ограничиваясь, приёмом
              платежей через банковские карты, электронные кошельки, мобильные
              платежи и другие средства платежей.
            </p>
          </div>
          <div className="block">
            ...
            <p className="p2">
              2.2. Клиенты обязуются предоставить достоверную информацию о себе
              и своих платежных данных.
            </p>
            <p className={"p2"}>
          ...
          <div className="block">
            ...
            <p className={"p2"}>
              3.2. Поставщик оставляет за собой право изменять тарифы на услуги
              с уведомлением клиентов не менее чем за 30 дней до вступления в
              силу изменений.
            </p>
          </div>
          <div className="block">
            ...
            <p className={"p2"}>
              4.1. Поставщик не несет ответственности за любые убытки, прямые
              или косвенные, понесенные клиентами в результате использования
              услуг.
            </p>
            <p className={"p2"}>
          ...
          <div className="block">
            ...
            <p className={"p2"}>
              5.1. Поставщик обязуется обрабатывать персональные данные клиентов
          ...
          <div className="block">
            ...
            <p className={"p2"}>
              6.1. Настоящая оферта является публичным документом и размещается
              на официальном сайте Поставщика.
            </p>
            <p className={"p2"}>
              6.2. В случае возникновения споров или разногласий, стороны
              обязуются приложить все усилия для их разрешения путем
              переговоров.
            </p>
            <p className={"p2"}>
