...
//             router.push(`/success-pay?id=${info.uuid}`);
//         } else {
//             router.push(`/failed-pay/${info.uuid}`);
//         }
//     }, [lastJsonMessage, router, info]);
//
//     useLayoutEffect(() => {
//         if (localStorage) {
...
//                     Что бы оплатить, вам нужно отсканировать <span className={styles.bold}>QR-код</span> в мобильном приложении банка или с помощью камеры вашего телефона.
//                 </p>
