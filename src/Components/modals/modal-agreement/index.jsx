    ...
    <div className={"root"}>
      ...
      <div className={"modal"}>
        ...
        <div className={"content"}>
          <p className={"text"}>
            Поставщик предлагает услуги по приёму платежей согласно следующим
            условиям:
          </p>
          <br />
          <p className={"text"}>
            1. Предмет оферты
            <br />
            Поставщик предоставляет услуги по приёму платежей от клиентов,
            включая, но не ограничиваясь, приёмом платежей через банковские
            карты, электронные кошельки, мобильные платежи и другие средства
            платежей.
          </p>
          <br />
          <p className={"text"}>
